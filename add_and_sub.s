...
_ADD_SUB:     
    MOV r11, #0						;clears register r11
    MOV r10, #0						;clears register r10
    MOV r9, #0						;clears register r9
    MOV r8, #0						;clears register r8
    MOV r7, #0       				;clears register r7
    MOV r3, #0						;clears register r3
    MOV r4, #0						;clears register r4
    MOV r5, #0						;clears register r5
    MOV r6, #0						;clears register r6
...
>>>>>>> 1a981ca751764bf6a18e0b058dfef3b5fcca2df7
